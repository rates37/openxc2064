...
import { Mux, Wire, Lut, Label, FlipFlop, ConnectionDot, EllipseNode, InputButton } from "../modals/LogicElementPrimitives";
...
const LogicElementModal: React.FC<LogicElementModalProps> = ({ isOpen, onClose, element, onSave }) => {
    ...
    const [muxConfig, setMuxConfig] = React.useState(element.muxConfig || {});
    const [lutConfig, setLutConfig] = React.useState(element.lutConfig || { "LUT 1": Array(8).fill(0), "LUT 2": Array(8).fill(0) });
    const [inputs, setInputs] = React.useState(element.inputs || { "A": 0, "B": 0, "C": 0, "D": 0, "K": 0 });
    const [nets, setNets] = React.useState(element.nets || {});
    ...
    const handleLutChange = (lutId: string, index: number) => {
        ...
        element.lutConfig = newLutConfig;
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                >
                    ...
                    <text x="10" y="550" fontSize="12" fill="red">
                        {`x: ${mousePos.x}, y: ${mousePos.y} ${highlightedNode ? `| Net: ${highlightedNode}` : ""}`}
                    </text>
                    ...
                    <g className="wires">
                        ...
                        <Wire d="M 435 200 L 445 200" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} /> <Wire d="M 436 202 L 444 202" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} /> <Wire d="M 437 204 L 443 204" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} />{" "}
                        ...
                        <Wire d="M 435 430 L 445 430" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} /> <Wire d="M 436 432 L 444 432" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} /> <Wire d="M 437 434 L 443 434" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} />{" "}
                        ...
                        <Wire d="M 411 362 L 421 362" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} /> <Wire d="M 412 364 L 420 364" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} /> <Wire d="M 413 366 L 419 366" id="net_GND" activated={nets["net_GND"] === 1} highlighted={highlightedNode === "net_GND"} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} />{" "}
                    ...
                    {/* LUTs */}
                    <Lut x={161.11} y={16} width={100} height={120} label={"LUT 1"} config={lutConfig["LUT 1"]} onChange={(i) => handleLutChange("LUT 1", i)} />
                    <Lut x={161.11} y={156} width={100} height={120} label={"LUT 2"} config={lutConfig["LUT 2"]} onChange={(i) => handleLutChange("LUT 2", i)} />
